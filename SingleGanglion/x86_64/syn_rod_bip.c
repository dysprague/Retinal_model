...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GradSyn /Users/danielsprague/BME_515/ProjModel/x86_64/syn_rod_bip.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 31 in file syn_rod_bip.mod:\n	SOLVE state METHOD euler\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 1; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/danielsprague/BME_515/ProjModel/syn_rod_bip.mod";
static const char* nmodl_file_text = 
