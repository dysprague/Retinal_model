...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 10, "ca_ion");
 	...
 	ivoc_help("help ?1 spike /Users/danielsprague/BME_515/ProjModel/x86_64/Ganglion_hh.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  states();
 if(error){fprintf(stderr,"at line 84 in file Ganglion_hh.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }   }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/danielsprague/BME_515/ProjModel/Ganglion_hh.mod";
static const char* nmodl_file_text = 
